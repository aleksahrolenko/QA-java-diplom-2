...
public class LoginUserTest {
    ...
    public void setUp() {
        ...
        this.email = "test" + random.nextInt(1000) + "@yandex.ru";
        this.password = "password" + random.nextInt(1000);
        CreateUser createUser = new CreateUser(email, password, "Sasha");
    ...
    @Test
    public void checkLoginUserIncorrect() {
        Random random = new Random();
        String emailNegative = "test" + random.nextInt(1000) + "@yandex.ru";
        String passwordNegative = "password" + random.nextInt(1000);
